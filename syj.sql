...
INSERT INTO `users` VALUES (1,'2013-04-12 01:42:26','123','123','234','234',NULL,NULL,'',NULL,''),(2,'2013-04-17 14:13:17','test','43bac31e54aeb1990bde3aefece94a1dcae7ceaf','test','dev@thinkjet.me',NULL,NULL,'','2013-04-20 23:58:19',''),(3,'2013-04-20 04:48:05','zyc','91cfddcd3362c3f22bd95b9f33f826051d8e488f','','tide.zyc@gmail.com',NULL,'oFF32p2aUVbnjoV6evYfuWMucxqCO1Ddvp9','\0',NULL,''),(5,'2013-04-20 04:58:40','zyc1','6800120beaf782406be23d977e9f2928d172de37','','zyc1016@126.com',NULL,'YtwxGH2FIN39GnFuMXct6nP3hV5VJXV5bbI','\0',NULL,'');
...
CREATE  TABLE `siyanjing`.`tags` (
  `id` bigint(20) NOT NULL ,
  `name` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) );
  
  CREATE  TABLE `siyanjing`.`activity_photo` (
  `id` BIGINT(20) NOT NULL ,
  `activity_id` BIGINT(20) NOT NULL ,
  `path` VARCHAR(200) NULL DEFAULT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_idx` (`activity_id` ASC) ,
  CONSTRAINT `photo`
    FOREIGN KEY (`activity_id` )
    REFERENCES `siyanjing`.`activity` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
  ...
  CREATE  TABLE `siyanjing`.`activity_summary` (
  `id` BIGINT(20) NOT NULL ,
  `activity_id` BIGINT(20) NOT NULL ,
  ...
  CONSTRAINT `fk`
    ...
    CREATE  TABLE `siyanjing`.`activity_tags` (
  `id` BIGINT(20) NOT NULL ,
  `activity_id` BIGINT(20) NOT NULL ,
  `tag_id` BIGINT(20) NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `activ_idx` (`activity_id` ASC) ,
